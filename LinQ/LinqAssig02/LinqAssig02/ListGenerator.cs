...
namespace LinqLect01
{
    internal static class ListGenerator
    {
        // this class acts as a container or helper, since the class is static, then the properity or method need to be statics
        public static List<Product> ProductList { get; set; }
        public static List<Customer> CustomerList { get; set; }

        static ListGenerator()  // if we need to initalize a data into static properity , we need to initalize them inside static constructor
        {
            ...
            CustomerList = new List<Customer>();   // the data will be comning from XML file
            CustomerList = (from e in XDocument.Load("Customers.xml").Root.Elements("customer")
                             select new Customer()
                             {
                                 CustomerId = (string)e.Element("id"),
                                 CustomrName = (string)e.Element("name"),
                                 Address = (string)e.Element("address"),
                                 City = (string)e.Element("city"),
                                 Region = (string)e.Element("region"),
                                 PostCode = (string)e.Element("postalcode"),
                                 Country = (string)e.Element("country"),
                                 Phones = (string)e.Element("phone"),
