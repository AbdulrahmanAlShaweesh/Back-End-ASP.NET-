...
{
    // used Where T : class, to left EF that it will work only on class ont any class only from baseentity class or  and class that inherit from the base entity class
